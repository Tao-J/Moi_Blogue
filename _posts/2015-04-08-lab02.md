...
layout: post
title: lab02
title_real: Try out file sharing systems
---
#lab02
[TOC]
##1. 实验板连接图
![](./Embeded_diagram_lab02.png)
...
+ 尝试使用`screen`连接`/dev/ttyS#`不知道传什么参数才能正确打开串口。
...
+ 首先`apt-get install smbclient`
+ 在等待安装过程中顺便配置一下Windows
	+ 先设置好Windows的计算机名称，我的电脑右键属性，然后更改计算机名，假设改成YIF。
